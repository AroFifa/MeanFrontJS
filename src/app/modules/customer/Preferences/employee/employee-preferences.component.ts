...
export class EmployeePreferencesComponent extends ShareComponent {
    ...
    syncData(query = this.filterQuery, data = {}) {
        this._userPreferencesService
            .getRatings("employees",this.page, this.itemsPerPage, query, data)
            .subscribe((data:any) => {
    ...
    onRateChange(event: any,employee:any) {
