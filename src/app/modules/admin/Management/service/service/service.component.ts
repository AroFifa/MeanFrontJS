...
export class ServiceComponent extends ShareComponent {
    ...
    initForm() {
        this.form = this._formBuilder.group({
            name: [''],
            min_price: [
                this.serviceFilterOptions.price.min,
                [
                    Validators.min(this.serviceFilterOptions.price.min),
                    Validators.max(this.serviceFilterOptions.price.max),
                ],
            ],
            max_price: [
                this.serviceFilterOptions.price.max,
                [
                    Validators.min(this.serviceFilterOptions.price.min),
                    Validators.max(this.serviceFilterOptions.price.max),
                ],
            ...
            min_duration: [
                this.serviceFilterOptions.duration.min,
                [
                    Validators.min(this.serviceFilterOptions.duration.min),
                    Validators.max(this.serviceFilterOptions.duration.max),
                ],
            ],
            max_duration: [
                this.serviceFilterOptions.duration.max,
                [
                    Validators.min(this.serviceFilterOptions.duration.min),
                    Validators.max(this.serviceFilterOptions.duration.max),
                ],
